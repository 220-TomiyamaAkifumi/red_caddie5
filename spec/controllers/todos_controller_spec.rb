  ...
  describe 'POST #create' do
    context 'with valid params' do
      it 'creates a new Todo' do
        expect do
          post :create,
               params: { todo: valid_attributes }, session: valid_session
    ...
    context 'with invalid params' do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create,
             params: { todo: invalid_attributes }, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe 'PUT #update' do
    context 'with valid params' do
      ...
      it 'updates the requested todo' do
        ...
        put :update,
            params: { id: todo.to_param, todo: new_attributes },
      ...
      it 'redirects to the todo' do
        Todo.create! valid_attributes
        put :update,
            params: { id: todo.to_param, todo: valid_attributes },
            session: valid_session
    ...
    context 'with invalid params' do
      it "returns a success response (i.e. to display the 'edit' template)" do
        Todo.create! valid_attributes
        put :update,
            params: { id: todo.to_param, todo: invalid_attributes },
            session: valid_session
        expect(response).to be_success
      end
    end
