...
# The default is nothing which will include only core features (password
...
Rails.application.config.sorcery.configure do |config|
  ...
  # i.e. [:twitter, :facebook, :github, :linkedin, :xing, :google, :liveid,
  # :salesforce, :slack] .
  # Default: `[]`
  #
  ...
  # config.linkedin.callback_url =
  #   "http://0.0.0.0:3000/oauth/callback?provider=linkedin"
  ...
  # config.xing.key = ""
  # config.xing.secret = ""
  # config.xing.callback_url =
  #   "http://0.0.0.0:3000/oauth/callback?provider=xing"
  # config.xing.user_info_mapping = {first_name: "first_name",
  # last_name: "last_name"}
  #
  #
  ...
  #   "http://0.0.0.0:3000/oauth/callback?provider=twitter"
  ...
  #   "http://0.0.0.0:3000/oauth/callback?provider=github"
  # config.github.user_info_mapping = {:email => "name"}
  # config.github.scope = ""
  #
  # config.paypal.key = ""
  # config.paypal.secret = ""
  # config.paypal.callback_url =
  #   "http://0.0.0.0:3000/oauth/callback?provider=paypal"
  # config.paypal.user_info_mapping = {:email => "email"}
  #
  # config.wechat.key = ""
  # config.wechat.secret = ""
  # config.wechat.callback_url =
  #   "http://0.0.0.0:3000/oauth/callback?provider=wechat"
  #
  # config.google.key = ""
  ...
  #
  # For Microsoft Graph, the key will be your App ID, and the secret will be
  # your app password/public key.
  # The callback URL "can't contain a query string or invalid special
  # characters", see: https://docs.microsoft.com/en-us/azure/active-directory/active-directory-v2-limitations#restrictions-on-redirect-uris
  ...
  #   "http://0.0.0.0:3000/oauth/callback/microsoft"
  # config.microsoft.user_info_mapping =
  #   {:email => "userPrincipalName", :username => "displayName"}
  # config.microsoft.scope =
  ...
  #   "http://0.0.0.0:3000/oauth/callback?provider=slack"
  # config.slack.key = ''
  # config.slack.secret = ''
  ...
  # config.liveid.callback_url =
  #   "http://mydomain.com:3000/oauth/callback?provider=liveid"
  ...
  # https://github.com/sumoheavy/jira-ruby or run openssl req -x509 -nodes
  # -newkey rsa:1024 -sha1 -keyout rsakey.pem -out rsacert.pem to obtain the
  # public key.
  ...
  # openssl req -new -newkey rsa:2048 -sha1 -days 365 -nodes -x509 -keyout
  # server.key -out server.crt
  # Make sure you have configured the application link properly
  # config.salesforce.key = '123123'
  # config.salesforce.secret = 'acb123'
  # config.salesforce.callback_url =
  #   "https://127.0.0.1:9292/oauth/callback?provider=salesforce"
  ...
  config.user_config do |user|
    ...
    # change *virtual* password attribute, the one which is used until an
    # encrypted one is generated.
    # Default: `:password`
    #
    ...
    # WARNING: If used for users' passwords, changing this key will leave
    ...
    # encryption algorithm name. See 'encryption_algorithm=' for available
    # options.
    # Default: `:bcrypt`
    #
    # user.encryption_algorithm =

    # make this configuration inheritable for subclasses. Useful for
    # ActiveRecord's STI.
    # Default: `false`
    #
    ...
    # logins/logouts (supporting remembering on multiple browsers
    # simultaneously).
    # Default: false
    #
    ...
    # how many seconds before the activation code expires. nil for never
    # expires.
    # Default: `nil`
    #
    ...
    # Default: :deliver (Rails version < 4.2) or :deliver_now
    # (Rails version 4.2+)
    #
    ...
    # do you want to prevent or allow users that did not activate by email to
    # login?
    # Default: `true`
    #
    ...
    # hammering protection, how long in seconds to wait before allowing another
    # email to be sent.
    # Default: `5 * 60`
    #
    ...
    # This field indicates whether user is banned and when it will be active
    # again.
